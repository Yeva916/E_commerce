...
@router.get("/{product_id}",response_model=InternalProductResponse)
...
@router.get("/{product_id}/stock",response_model=InventoryResponse)
...
@router.post("/{product_id}/reserve",response_model=ReservationResponse) #when the order is placed
...
@router.post("/{product_id}/release",response_model=ReleaseResponse) #if user cancels the order
